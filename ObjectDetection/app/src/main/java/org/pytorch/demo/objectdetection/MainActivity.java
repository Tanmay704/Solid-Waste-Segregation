...
public class MainActivity extends AppCompatActivity implements Runnable {
    ...
    long getCurrCount3 = 0;
    long getCurrCount4 = 0;
    long getCurrCount5 = 0;
    long getCurrCount6 = 0;
...
//
    ...
    public void run() {
        ...
        AUGarbgaecount aug = new AUGarbgaecount();


        btn.setOnClickListener(v -> {
            if (results.size() != 0 && flag.get() == true) {
                ...
                aug.update(locality,formattedDate,getCurrCount1, getCurrCount2, getCurrCount3, getCurrCount4, getCurrCount5, getCurrCount6).addOnSuccessListener(er -> {
